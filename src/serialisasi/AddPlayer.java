...
public class AddPlayer extends javax.swing.JDialog {
    ...
    public void initTabel(){
        model = new javax.swing.table.DefaultTableModel(
                new Object[][][][][]{},
                new String []{"ID Player","Nama Player","Password","Usia","Email"}
        );
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "DATA PLAYER", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION));

        jLabel3.setText("ID Player");

        jLabel4.setText("Nama Player");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(txtIdPlayer, javax.swing.GroupLayout.PREFERRED_SIZE, 400, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        // TODO add your handling code here:
        String id_game = txtIdGame.getText();
        String nama_game = txtNamaGame.getText();
        int row = tblData.getRowCount();
        
        if(id_game.isEmpty() || nama_game.isEmpty()){
            JOptionPane.showMessageDialog(this, "Mohon Lengkapi data Player !");
        }else if(row == 0){
            JOptionPane.showMessageDialog(this, "Item masih kosong !");
        }else{
            List<Player> p = new ArrayList<>();
            for (int i = 0 ; i<row; i++){
                String id_player = tblData.getValueAt(i, 0).toString();
                String nama_player = tblData.getValueAt(i, 1).toString();
                String password = tblData.getValueAt(i, 2).toString();
                String usia_player = tblData.getValueAt(i, 3).toString();
                String Email = tblData.getValueAt(i, 4).toString();
                int usia = Integer.parseInt(usia_player);
                Player pi = new Player (id_player, nama_player, password, usia, Email);
                p.add(pi);
            }
            MainForm.game.setId_Game(id_game);
            MainForm.game.setNama_Game(nama_game);
            MainForm.game.setPlayers(p);
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        // TODO add your handling code here:
        String txt_id_player = txtIdPlayer.getText();
        String txt_nama_player = txtNamaGame.getText();
